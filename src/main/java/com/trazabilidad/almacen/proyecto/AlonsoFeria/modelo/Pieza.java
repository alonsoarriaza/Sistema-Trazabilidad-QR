 ...
 * una máquina dentro del sistema de trazabilidad del taller de trazabilidad.
 *
 ...
 * almacen_trazabilidad. Se utiliza ddl-auto=none, por lo que la estructura de
...
public class Pieza {
     ...
     * permitiendo la trazabilidad inversa completa.
     */
     ...
     * (ej. "SC 552"). Complementa la trazabilidad para diagnósticos
