 ...
 * una máquina dentro del sistema de techcorp del taller de techcorp.
 *
...
public class Pieza {
     ...
     * permitiendo la techcorp inversa completa.
     */
     ...
     * (ej. "SC 552"). Complementa la techcorp para diagnósticos
